...
export const languages = {
  ko: {
    ...
    popupSaveSuccess: `측정 기록 저장 완료! ${svgIcon('celebration', 'mi-inline mi-sm')}`,
    popupUpdateSuccess: `측정 기록 수정 완료! ${svgIcon('auto_awesome', 'mi-inline mi-sm')}`,
    popupDeleteSuccess: "측정 기록 삭제 완료 ",
    popupTargetSaveSuccess: "목표 저장 완료! ",
    popupNoteSaveSuccess: `새 플래닝 저장 완료! ${svgIcon('celebration', 'mi-inline mi-sm')}`,
    popupNoteUpdateSuccess: `플래닝 수정 완료! ${svgIcon('auto_awesome', 'mi-inline mi-sm')}`,
    popupNoteDeleteSuccess: "플래닝 삭제 완료 ",
    popupDataExportSuccess: `데이터 내보내기 성공! ${svgIcon('celebration', 'mi-inline mi-sm')}`,
    popupDataImportSuccess: `데이터 가져오기 성공! ${svgIcon('auto_awesome', 'mi-inline mi-sm')}`,
    popupDataResetSuccess: `모든 데이터가 초기화되었습니다. ${svgIcon('auto_awesome', 'mi-inline mi-sm')}`,
    ...
    testNotificationBody: `알림이 잘 작동하고 있어요! ${svgIcon('celebration', 'mi-inline mi-sm')}`,
    ...
    resetWarning: `${svgIcon('warning', 'mi-inline mi-sm mi-error')} 모든 데이터(측정, 목표, 플래닝)가 영구적으로 삭제됩니다! 초기화 전에 꼭! 데이터를 파일로 백업해주세요.`,
    resetDataButton: "모든 데이터 초기화",
    infoTitle: "정보",
    versionLabel: "버전:",
    privacyInfo: `이 앱은 오프라인 작동하며 모든 데이터는 앱에만 안전하게 저장됩니다! ${svgIcon('sentiment_satisfied', 'mi-inline mi-sm')}`,
    ...
    popupAlreadyLatest: `이미 최신 버전이에요! ${svgIcon('auto_awesome', 'mi-inline mi-sm')}`,
  ...
  en: {
    ...
    popupSaveSuccess: `Measurement saved! ${svgIcon('celebration', 'mi-inline mi-sm')}`,
    popupUpdateSuccess: `Measurement updated! ${svgIcon('auto_awesome', 'mi-inline mi-sm')}`,
    popupDeleteSuccess: "Measurement deleted ",
    popupTargetSaveSuccess: "Targets saved! ",
    popupNoteSaveSuccess: `New Planning saved! ${svgIcon('celebration', 'mi-inline mi-sm')}`,
    popupNoteUpdateSuccess: `Planning updated! ${svgIcon('auto_awesome', 'mi-inline mi-sm')}`,
    popupNoteDeleteSuccess: "Planning deleted ",
    popupDataExportSuccess: `Data export successful! ${svgIcon('celebration', 'mi-inline mi-sm')}`,
    popupDataImportSuccess: `Data import successful! ${svgIcon('auto_awesome', 'mi-inline mi-sm')}`,
    popupDataResetSuccess: `All data has been reset. ${svgIcon('auto_awesome', 'mi-inline mi-sm')}`,
    ...
    testNotificationBody: `Notifications are working! ${svgIcon('celebration', 'mi-inline mi-sm')}`,
    ...
    resetWarning: `${svgIcon('warning', 'mi-inline mi-sm mi-error')} Resetting data will permanently delete all records (measurements, targets, Planning)! Please back up your data before resetting.`,
    resetDataButton: "Reset All Data",
    infoTitle: "Information",
    versionLabel: "Version:",
    privacyInfo: `This app works offline and all data is stored securely only in your browser! ${svgIcon('sentiment_satisfied', 'mi-inline mi-sm')}`,
    ...
    popupAlreadyLatest: `You are already on the latest version! ${svgIcon('auto_awesome', 'mi-inline mi-sm')}`,
  ...
  ja: {
    ...
    popupSaveSuccess: `測定記録 保存完了！${svgIcon('celebration', 'mi-inline mi-sm')}`,
    popupUpdateSuccess: `測定記録 更新完了！${svgIcon('auto_awesome', 'mi-inline mi-sm')}`,
    popupDeleteSuccess: "測定記録 削除完了 ",
    popupTargetSaveSuccess: "目標 保存完了！",
    popupNoteSaveSuccess: `新規プラン 保存完了！${svgIcon('celebration', 'mi-inline mi-sm')}`,
    popupNoteUpdateSuccess: `プラン 更新完了！${svgIcon('auto_awesome', 'mi-inline mi-sm')}`,
    popupNoteDeleteSuccess: "プラン 削除完了 ",
    popupDataExportSuccess: `データ エクスポート成功！${svgIcon('celebration', 'mi-inline mi-sm')}`,
    popupDataImportSuccess: `データ インポート成功！${svgIcon('auto_awesome', 'mi-inline mi-sm')}`,
    popupDataResetSuccess: `全データ リセット完了。 ${svgIcon('auto_awesome', 'mi-inline mi-sm')}`,
    ...
    testNotificationBody: `通知が正常に動作しています！${svgIcon('celebration', 'mi-inline mi-sm')}`,
    ...
    severeWarning: "！！！警告！！！",
    resetWarning: `${svgIcon('warning', 'mi-inline mi-sm mi-error')} すべてのデータ（測定、目標、プラン）が完全に削除されます！ 初期化する前に必ずデータをファイルにバックアップしてください。`,
    resetDataButton: "すべてのデータを初期化",
    infoTitle: "情報",
    versionLabel: "バージョン:",
    privacyInfo: `このアプリはオフラインで動作し、すべてのデータはブラウザ内にのみ安全に保存されます！ ${svgIcon('sentiment_satisfied', 'mi-inline mi-sm')}`,
    ...
    popupAlreadyLatest: `すでに最新バージョンです！${svgIcon('auto_awesome', 'mi-inline mi-sm')}`,
