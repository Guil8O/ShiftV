...
export const languages = {
  ko: {
    ...
    severityLow: "참고",
    severityInfo: "정보",
    healthCategoryDiet: "식단",
    healthCategoryExercise: "운동",
    healthCategoryMedication: "의약",
    healthCategoryLifestyle: "생활습관",
    hormoneEstradiol: "에스트라디올 (E2)",
    hormoneTestosterone: "테스토스테론 (T)",
    ...
    onboardingCloudChecking: "클라우드 데이터 확인 중...",
    onboardingCloudLoading: "클라우드 데이터 불러오는 중...",
    onboardingCloudDone: "클라우드 데이터를 불러왔습니다!",
    onboardingCloudConfirmMsg: "{date} 데이터가 있습니다. 불러오겠습니까?",
    ...
    hormoneRangeTitle: "호르몬 범위 평가",
    // body-briefing-modal
    safetyNotDiagnosis: "⚠ 확정 진단이 아닙니다.",
    safetyRecommendedTests: "권장 검사",
    safetyDrugInfo: "약물 안전 정보",
    radarBodyFat: "체지방",
    radarIdeal: "이상적",
    radarMuscle: "근육량",
    radarTarget: "목표",
    radarWHR: "허리-엉덩이 비율",
    radarHormones: "호르몬 균형",
    radarGoals: "목표 달성",
    radarBodyChange: "신체 변화",
    radarNotEnoughData: "레이더 차트를 표시하기에 데이터가 부족합니다. 더 많은 측정값을 기록하세요.",
    radarCurrent: "현재",
    radarPrevious: "이전",
    silhouetteNoData: "신체 측정 기록이 없습니다.",
    silhouetteAriaLabel: "신체 측정 시각화",
    bodyType_average: "표준",
    bodyType_pear: "하체형",
    bodyType_hourglass: "모래시계형",
    bodyType_inverted: "역삼각형",
    bodyType_slim: "슬림",
    briefingWeekLabel: "{week}주차",
    // pdf-report
    bodyFat: "체지방률",
    bust: "가슴둘레",
    hip: "엉덩이둘레",
    ...
    percentileMale: "남성 {value}%",
    percentileFemale: "여성 {value}%",
    removeSymptom: "제거",
    ...
    // Premium & Paywall
    premiumTitle: "ShiftV 프리미엄",
    premiumSubtitle: "더 강력한 기능으로 여정을 관리하세요",
    planFree: "Free",
    planPlus: "Plus",
    planAiPlus: "AI Plus",
    planCurrent: "현재 플랜",
    ...
    planYearly: "연간 (20% 할인)",
    priceFree: "무료",
    pricePlusOneTime: "₩4,900",
    priceAiPlusMonthly: "₩4,900/월",
    priceAiPlusYearly: "₩46,800/년",
    featureUnlimitedRecords: "무제한 기록 & 추적",
    featureBasicCharts: "기본 차트",
    featureLanguages: "3개 언어 지원",
    featureAdFree: "광고 없음",
    featureUnlimitedPdf: "무제한 PDF 보고서",
    featureCloudMulti: "클라우드 동기화 ({n}기기)",
    featurePhotoCloud: "사진 클라우드 백업",
    featureAiTokens: "AI 분석 (하루 {n}회)",
    featureAiPersonalApi: "AI 분석 (개인 API 키)",
    featurePremiumBadge: "프리미엄 뱃지",
    featurePrioritySupport: "우선 고객지원",
    paywallDailyLimit: "일일 무료 한도에 도달했어요",
    paywallDailyLimitDesc: "오늘의 무료 {feature} 사용 횟수({limit}회)를 모두 사용했어요.",
    paywallPremiumRequired: "프리미엄 기능이에요",
    paywallPremiumRequiredDesc: "이 기능은 Plus 이상 플랜에서 사용할 수 있어요.",
    paywallUpgradeBtn: "플랜 업그레이드",
    paywallMaybeLater: "나중에",
    promoCodeLabel: "프로모션 코드",
    promoCodePlaceholder: "코드를 입력하세요",
    promoCodeApply: "적용",
    promoCodeSuccess: "프로모션 코드가 적용되었어요! ({plan})",
    promoCodeInvalid: "유효하지 않은 코드예요",
    subscriptionManagement: "구독 관리",
    featurePdfReport: "PDF 보고서",
    featureAiAnalysis: "AI 분석",
    featureDataExport: "데이터 내보내기",
    dailyLimitReached: "일일 한도 도달 ({used}/{limit})",
    remainingToday: "오늘 남은 횟수: {n}회"
  },
  en: {
    save: "Save",
    edit: "Edit",
    ...
    severityLow: "Note",
    severityInfo: "Info",
    healthCategoryDiet: "Diet",
    healthCategoryExercise: "Exercise",
    healthCategoryMedication: "Medical",
    healthCategoryLifestyle: "Lifestyle",
    hormoneEstradiol: "Estradiol (E2)",
    hormoneTestosterone: "Testosterone (T)",
    ...
    onboardingCloudChecking: "Checking cloud data...",
    onboardingCloudLoading: "Loading cloud data...",
    onboardingCloudDone: "Cloud data loaded successfully!",
    onboardingCloudConfirmMsg: "Data from {date} found. Would you like to load it?",
    ...
    percentileMale: "♂ {value}%",
    percentileFemale: "♀ {value}%",
    ...
    // body-briefing-modal
    safetyNotDiagnosis: "⚠ Not a confirmed diagnosis.",
    safetyRecommendedTests: "Recommended Tests",
    safetyDrugInfo: "Drug Safety Information",
    radarBodyFat: "Body Fat",
    radarIdeal: "Ideal",
    radarMuscle: "Muscle",
    radarTarget: "Target",
    radarWHR: "WHR",
    radarHormones: "Hormones",
    radarGoals: "Goals",
    radarBodyChange: "Body Change",
    radarNotEnoughData: "Not enough data for radar chart. Record more measurements.",
    radarCurrent: "Current",
    radarPrevious: "Previous",
    silhouetteNoData: "No body measurement data recorded.",
    silhouetteAriaLabel: "Body measurement visualization",
    bodyType_average: "Average",
    bodyType_pear: "Pear",
    bodyType_hourglass: "Hourglass",
    bodyType_inverted: "Inverted Triangle",
    bodyType_slim: "Slim",
    briefingWeekLabel: "Week {week}",
    // pdf-report
    bodyFat: "Body Fat %",
    bust: "Chest",
    hip: "Hips",
    ...
    // Premium & Paywall
    premiumTitle: "ShiftV Premium",
    premiumSubtitle: "Manage your journey with powerful features",
    planFree: "Free",
    planPlus: "Plus",
    planAiPlus: "AI Plus",
    ...
    planUpgrade: "Upgrade",
    planActive: "Active",
    planExpiry: "Expires: {date}",
    planPermanent: "Permanent",
    planOneTime: "One-time purchase",
    planMonthly: "Monthly",
    planYearly: "Yearly (20% off)",
    priceFree: "Free",
    pricePlusOneTime: "$3.99",
    priceAiPlusMonthly: "$3.99/mo",
    priceAiPlusYearly: "$37.99/yr",
    featureUnlimitedRecords: "Unlimited records & tracking",
    featureBasicCharts: "Basic charts",
    featureLanguages: "3 language support",
    featureAdFree: "Ad-free",
    featureUnlimitedPdf: "Unlimited PDF reports",
    featureCloudMulti: "Cloud sync ({n} devices)",
    featurePhotoCloud: "Photo cloud backup",
    featureAiTokens: "AI analysis ({n} per day)",
    featureAiPersonalApi: "AI analysis (personal API key)",
    featurePremiumBadge: "Premium badge",
    featurePrioritySupport: "Priority support",
    paywallDailyLimit: "Daily free limit reached",
    paywallDailyLimitDesc: "You've used all {limit} free {feature} for today.",
    paywallPremiumRequired: "Premium Feature",
    paywallPremiumRequiredDesc: "This feature requires a Plus plan or higher.",
    paywallUpgradeBtn: "Upgrade Plan",
    paywallMaybeLater: "Maybe Later",
    promoCodeLabel: "Promo Code",
    promoCodePlaceholder: "Enter code",
    promoCodeApply: "Apply",
    promoCodeSuccess: "Promo code applied! ({plan})",
    promoCodeInvalid: "Invalid code",
    subscriptionManagement: "Subscription",
    featurePdfReport: "PDF Report",
    featureAiAnalysis: "AI Analysis",
    featureDataExport: "Data Export",
    dailyLimitReached: "Daily limit reached ({used}/{limit})",
    remainingToday: "Remaining today: {n}"
  },
  ja: {
    save: "保存",
    edit: "編集",
    ...
    severityLow: "参考",
    severityInfo: "情報",
    healthCategoryDiet: "食事",
    healthCategoryExercise: "運動",
    healthCategoryMedication: "医薬",
    healthCategoryLifestyle: "生活習慣",
    hormoneEstradiol: "エストラジオール (E2)",
    hormoneTestosterone: "テストステロン (T)",
    ...
    onboardingCloudChecking: "クラウドデータを確認中...",
    onboardingCloudLoading: "クラウドデータを読み込み中...",
    onboardingCloudDone: "クラウドデータを読み込みました！",
    onboardingCloudConfirmMsg: "{date}のデータがあります。読み込みますか？",
    ...
    // body-briefing-modal
    safetyNotDiagnosis: "⚠ 確定診断ではありません。",
    safetyRecommendedTests: "推奨検査",
    safetyDrugInfo: "薬物安全情報",
    radarBodyFat: "体脂肪",
    radarIdeal: "理想的",
    radarMuscle: "筋肉量",
    radarTarget: "目標",
    radarWHR: "WHR",
    radarHormones: "ホルモンバランス",
    radarGoals: "目標達成",
    radarBodyChange: "身体変化",
    radarNotEnoughData: "レーダーチャートに十分なデータがありません。もっと測定値を記録してください。",
    radarCurrent: "現在",
    radarPrevious: "前回",
    silhouetteNoData: "身体測定記録がありません。",
    silhouetteAriaLabel: "身体測定ビジュアル",
    bodyType_average: "標準",
    bodyType_pear: "下半身型",
    bodyType_hourglass: "砂時計型",
    bodyType_inverted: "逆三角型",
    bodyType_slim: "スリム",
    briefingWeekLabel: "{week}週目",
    // pdf-report
    bodyFat: "体脂肪率",
    bust: "胸囲",
    hip: "ヒップ",
    ...
    percentileMale: "男性 {value}%",
    percentileFemale: "女性 {value}%",
    targetTitle: "目標設定",
    ...
    // Premium & Paywall
    premiumTitle: "ShiftV プレミアム",
    premiumSubtitle: "より強力な機能であなたの旅をサポート",
    planFree: "Free",
    planPlus: "Plus",
    planAiPlus: "AI Plus",
    planCurrent: "現在のプラン",
    planUpgrade: "アップグレード",
    planActive: "利用中",
    planExpiry: "有効期限: {date}",
    planPermanent: "永久",
    planOneTime: "買い切り",
    planMonthly: "月額",
    planYearly: "年額 (20%OFF)",
    priceFree: "無料",
    pricePlusOneTime: "¥700",
    priceAiPlusMonthly: "¥700/月",
    priceAiPlusYearly: "¥6,800/年",
    featureUnlimitedRecords: "無制限の記録 & トラッキング",
    featureBasicCharts: "基本チャート",
    featureLanguages: "3言語サポート",
    featureAdFree: "広告なし",
    featureUnlimitedPdf: "無制限PDFレポート",
    featureCloudMulti: "クラウド同期 ({n}台)",
    featurePhotoCloud: "写真クラウドバックアップ",
    featureAiTokens: "AI分析 (1日{n}回)",
    featureAiPersonalApi: "AI分析 (個人APIキー)",
    featurePremiumBadge: "プレミアムバッジ",
    featurePrioritySupport: "優先サポート",
    paywallDailyLimit: "1日の無料回数に達しました",
    paywallDailyLimitDesc: "本日の無料{feature}回数({limit}回)をすべて使用しました。",
    paywallPremiumRequired: "プレミアム機能",
    paywallPremiumRequiredDesc: "この機能はPlus以上のプランで利用できます。",
    paywallUpgradeBtn: "プランをアップグレード",
    paywallMaybeLater: "あとで",
    promoCodeLabel: "プロモーションコード",
    promoCodePlaceholder: "コードを入力",
    promoCodeApply: "適用",
    promoCodeSuccess: "プロモコードが適用されました！ ({plan})",
    promoCodeInvalid: "無効なコードです",
    subscriptionManagement: "サブスクリプション",
    featurePdfReport: "PDFレポート",
    featureAiAnalysis: "AI分析",
    featureDataExport: "データエクスポート",
    dailyLimitReached: "1日の上限に達しました ({used}/{limit})",
    remainingToday: "本日残り: {n}回"
  }
};
