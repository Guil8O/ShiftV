...
export const languages = {
  ko: {
    ...
    percentileMale: "남성 상위 {value}%",
    percentileFemale: "여성 상위 {value}%",
    percentileMaleBottom: "남성 하위 {value}%",
    percentileFemaleBottom: "여성 하위 {value}%",
    removeSymptom: "제거",
  ...
  en: {
    ...
    percentileMale: "♂ top {value}%",
    percentileFemale: "♀ top {value}%",
    percentileMaleBottom: "♂ bottom {value}%",
    percentileFemaleBottom: "♀ bottom {value}%",
  ...
  ja: {
    ...
    percentileMale: "男性上位 {value}%",
    percentileFemale: "女性上位 {value}%",
    percentileMaleBottom: "男性下位 {value}%",
    percentileFemaleBottom: "女性下位 {value}%",
    targetTitle: "目標設定",
