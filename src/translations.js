...
export const languages = {
    ko: {
        ...
        "targetAchievement.moving_away_trend": "현재 추세로는 목표에서 멀어지고 있습니다.",
        "targetAchievement.almost_there": "💪 다 왔어요! 약 {weeksLeft}주 남았습니다!",
        "targetAchievement.on_track": "순조로워요! 약 {weeksLeft}주 예상됩니다.",
    ...
    en: {
        ...
        "targetAchievement.moving_away_trend": "You are moving away from the goal with the current trend.",
        "targetAchievement.almost_there": "💪 Almost there! About {weeksLeft} weeks left!",
        "targetAchievement.on_track": "Progressing smoothly. Estimated {weeksLeft} weeks.",
        ...
        // SV Card / Tabs / Notifications (filled)
        tabMain: "Main",
        tabRecord: "Record",
        tabMy: "My",
    ...
    ja: {
        ...
        libido: '性欲 (回/週)',
        estrogenLevel: 'エストロゲン値',
        testosteroneLevel: 'テストステロン値',
        ...
        "targetAchievement.moving_away_trend": "現在の傾向では目標から離れています。",
        "targetAchievement.almost_there": "💪 もう少し！約{weeksLeft}週間残っています！",
        "targetAchievement.on_track": "順調です！約{weeksLeft}週間と予想されます。",
        "targetAchievement.long_term": "🎯 長期目標です。約{weeksLeft}週間（{months}ヶ月）と予想されます。",
        "targetAchievement.moving_away": "⚠️ 目標から離れています。計画を見直してください。",
        "targetAchievement.too_slow": "🐌 変化が遅すぎます。より積極的なアプローチが必要です。",
        "targetAchievement.already_achieved": "目標は既に達成されました！🎉",
        "targetAchievement.review_habits": "生活習慣や運動計画を見直してください。",
        "targetAchievement.too_slow_rate": "現在の変化率では目標達成が非常に遅いです。",
        "targetAchievement.need_more_active": "より積極的なアプローチが必要かもしれません。",
